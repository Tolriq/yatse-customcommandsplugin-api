 ...
 * - {@link CustomCommandsActivity#cancelAndFinish()} to cancel any change and return to Yatse.<br/>
 * - {@link CustomCommandsActivity#saveAndFinish()} to return the updated pluginCustomCommand for adding / saving in Yatse.
 */
public abstract class CustomCommandsActivity extends Activity {

    public final static String EXTRA_CUSTOM_COMMAND = "tv.yatse.plugin.customcommands.EXTRA_CUSTOM_COMMAND";
